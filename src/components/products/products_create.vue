    ...
    <div class="page-table scrollable">
        ...
        <el-form ref="form" :rules="rules" :model="form"  label-width="170px">
            ...
            <el-form-item label="Terms & Conditions" prop="terms_n_conditions">
                <el-input type="textarea" v-model="form.terms_n_conditions"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Other Conditions" prop="eligible_other_conditions">
                <el-input type="textarea" v-model="form.eligible_other_conditions"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Bank account" prop="bank_account">
                <el-input type="number" v-model="form.bank_account"></el-input>
            </el-form-item>
        ...
        methods: {
            ...
            uploadXlsx(){
                ...
                if (this.xlsx != ''){
                    ...
                    let url = this.url + '/products/excel';
