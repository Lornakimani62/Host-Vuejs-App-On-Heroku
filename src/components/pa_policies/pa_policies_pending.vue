<template>
    ...
    <div class="page-table scrollable">
        <h2 class="animated fadeInDown" >Pending Policies</h2>
        <el-row id="space">
            ...
            <el-table :data="tableData" height="475" style="width: 100%">
                ...
                <el-table-column fixed="right" label="Operations" width="250">
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button type="success" size="mini" slot="reference" @click="handleApprove(scope.$index, scope.row)"></i><span>Approve</span></el-button>
                    </template>
    ...
    export default {
        ...
        methods: {
            ...
            exportXlsx(){
                ...
                XLSX.writeFile(policiesyWb, 'PA-Pending Policies.xlsx');
            },

            addClicked(){
                this.$router.push('/papolicies/add');
            },
            ...
            handleEdit(index,row){
                ...
                this.$router.push('/papolicies/edit/'+this.id);
            },
            handleApprove(index,row){
                this.form=row;
                this.id=this.form.pa_policy_id;
                this.$router.push('/papolicies/approve/'+this.id);
            },
