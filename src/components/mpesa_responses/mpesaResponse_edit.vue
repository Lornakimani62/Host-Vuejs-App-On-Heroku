        ...
        <el-form ref="form" :rules="rules" :model="form"  label-width="150px">
            ...
            <el-form-item label="Transaction Date" prop="transaction_date">
             ...
             <el-form-item label="Amount recieved" prop="amount_received">
                <el-input v-model="form.amount_received"></el-input>
            </el-form-item>
...
<script>
    export default {
        ...
        methods: {
            cancelClicked(){
                this.$router.push('/mpesaresponses');
            },
            ...
            onSubmit(form){
                this.$refs[form].validate((valid) => {
                        if (valid) {
                let url = this.url + '/mpesaresponses/'+this.id ;
            ...
            getMpesaresponse(){
                let url = this.url + '/mpesaresponses/'+this.$route.params.id ;
