    ...
    export default {
        ...
        methods: {
            ...
            exportXlsx(){
                ...
                XLSX.writeFile(coversyWb, 'Motor Covers.xlsx');

            },

            addClicked(){
                this.$router.push('motorcovers/add');
            },

            handleDelete(index, row) {
                let url = this.url + '/motorcovers/' + row.motor_cover_id;
            ...
            handleEdit(index,row){
                this.form=row;
                this.id=this.form.motor_cover_id;
                this.$router.push('/motorcovers/edit/'+this.id);
            },
            ...
            onSubmit() {
                let url = this.url + '/motorcovers/' + this.form.motor_cover_id;
