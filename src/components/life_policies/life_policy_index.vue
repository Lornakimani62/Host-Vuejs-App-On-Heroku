  ...
  <div>
    ...
    <div class="table-box card-base card-shadow--medium">
      <el-table :data="tableData" height="475" style="width: 100%">
        <el-table-column prop="life_policy_id" sortable label="ID" width="60"></el-table-column>
        ...
        <el-table-column prop="premium" label="Premium" width="150"></el-table-column>
        <el-table-column prop="applicant_dob" label="Applicant DOB" width="150"></el-table-column>
        <el-table-column prop="applicant_name" label="Applicant name" width="150"></el-table-column>
        <el-table-column prop="applicant_idno" label="Applicant ID" sortable width="180"></el-table-column>
        <el-table-column prop="applicant_idfront" label="Applicant ID Front" width="150"></el-table-column>
        <el-table-column prop="applicant_idback" label="Applicant ID Back" width="150"></el-table-column>
        <el-table-column prop="applicant_photo" label="Applicant Photo" width="150"></el-table-column>
        ...
        <el-table-column
          ...
          width="150"
        ></el-table-column>
        <el-table-column prop="notin_goodhealth" label="Not in good Health" width="150"></el-table-column>
        <el-table-column prop="rider1_included" label="Rider 1" width="150"></el-table-column>
        <el-table-column prop="rider2_included" label="Rider 2" width="150"></el-table-column>
        <el-table-column prop="rider3_included" label="Rider 3" width="150"></el-table-column>
