    ...
    export default {
        ...
        methods: {
            ...
            exportXlsx(){
                ...
                XLSX.writeFile(coversyWb, 'Covers.xlsx');

            },

            addClicked(){
                this.$router.push('pa_covers/add');
            },

            handleDelete(index, row) {

                let url = this.url + '/pacovers/' + row.pa_cover_id;
            ...
            handleEdit(index,row){
                this.form=row;
                this.id=this.form.pa_cover_id;
                this.$router.push('/pa_covers/edit/'+this.id);
            },
            ...
            onSubmit() {
                let url = this.url + '/pacovers/' + this.form.pa_claims_id;
