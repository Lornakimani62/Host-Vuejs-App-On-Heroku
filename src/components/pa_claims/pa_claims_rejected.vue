 <template>
     ...
     <div class="page-table scrollable">
         <h1 class="animated fadeInDown" >Rejected Claims</h1>
         <el-row id="space">
             ...
             <el-table :data="tableData" height="475" style="width: 100%">
                 ...
                 <el-table-column fixed="right" label="Operations" width="250">
                     ...
                     <template slot-scope="scope">
                         ...
                         <el-button  size="mini" type="danger" slot="reference" @click="handleDelete(scope.$index, scope.row)">Delete</el-button>
                     </template>
                 </el-table-column>
 ...
 <script>
     ...
     export default {
         ...
         methods: {
             ...
             getClaims() {
                 let url = this.url + '/paclaimsrejected';
             ...
             handleDelete(index, row) {
                 ...
                 let url = this.url + '/paclaims/' + row.pa_claims_id;
             ...
             handleEdit(index, row) {
                 this.form = row;
                 this.id = this.form.pa_claims_id;
                 this.$router.push('/pa_claims/edit/' + this.id);
             },
             exportXlsx() {
                 ...
                 XLSX.writeFile(paClaimsWb, 'PA-Claims.xlsx');

             },

             addClicked() {
                 this.$router.push('pa_claims/add');
             },
			 handleReview(index, row) {
				 this.form = row;
				 this.id = this.form.pa_claims_id;
				 this.$router.push('/paclaims/review/' + this.id);
			 },
