    ...
    <div class="page-table scrollable">
        <el-form ref="form" :rules="rules" :model="form" label-width="150px">
            ...
            <el-form-item label="Claim Ref No" prop="claim_refno">
                <el-input  v-model="form.claim_refno"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Claim Estimate" prop="claim_est_amount">
                <el-input  v-model="form.claim_est_amount"></el-input>
            </el-form-item>
            <el-form-item label="Approved amount" prop="claim_appr_amount">
                <el-input  v-model="form.claim_appr_amount"></el-input>
            </el-form-item>
            ...
            <el-form-item label="Approved on" prop="approved_on">
                <el-col :span="11">
                    <el-date-picker value-format="yyyy-MM-dd"  type="date" placeholder="Pick a date" v-model="form.approved_on" style="width: 70%;"></el-date-picker>
                </el-col>
            ...
            return{
                ...
                rules: {
                    ...
                    claim_currency: [
                        ...
                        {min: 3, max: 3, message: 'Please enter a valid 8 digit ID', trigger: 'blur'}
                    ],
                    ...
                    applicant_idno: [
                        ...
                        {min: 8, max: 8, message: 'Please enter 8 digits', trigger: 'blur'}
                    ],
