		...
		<div class="box-right flex align-center pl-10">
			...
			<el-dropdown trigger="click" @command="onCommandLang">
				...
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item command="us"><i class="flag-icon flag-icon-ke mr-15"></i>English</el-dropdown-item>
				</el-dropdown-menu>
			</el-dropdown>
			...
			<span class="username"><router-link to="/profile">{{fullname}}</router-link></span>
			<el-dropdown trigger="click" @command="onCommand">
				<span class="el-dropdown-link">
					<img :src="profileurl" class="avatar" alt="avatar">
				</span>
				<el-dropdown-menu slot="dropdown">
